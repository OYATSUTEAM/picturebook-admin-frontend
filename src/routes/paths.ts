...
export const paths = {
  ...
  dashboard: {
    ...
    admin: {
      ...
      profile: `${ROOTS.DASHBOARD}/admin/profile`,
      account: `${ROOTS.DASHBOARD}/admin/account`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/admin/${id}/edit`,
      demo: {
        edit: `${ROOTS.DASHBOARD}/admin/${MOCK_ID}/edit`,
      },
      product: {
        root: `${ROOTS.DASHBOARD}/admin/product`,
        fileManager: `${ROOTS.DASHBOARD}/admin/file-manager`,
        ...
        demo: {
          details: `${ROOTS.DASHBOARD}/product/admin/${MOCK_ID}`,
          edit: `${ROOTS.DASHBOARD}/product/admin/${MOCK_ID}/edit`,
        },
      },
    },
